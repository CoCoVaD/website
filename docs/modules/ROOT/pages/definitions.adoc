...
:mp: mailto:Marc.Pantel@toulouse-inp.fr[Marc Pantel]
:se: mailto:sophie.ebersold@irit.fr[Sophie Ebersold]
:nh: mailto:nathalie.hernandez@irit.fr[Nathalie Hernandez]
:imen: mailto:imen.sayar@irit.fr[Imen Sayar]
:holder: {jmb}
:myinitials: JMB
:icons: font
:xrefstyle: short
...
// short full basic
:experimental:
:cocovad-url: https://CoCovaD.github.io/website
:cocovad: {cocovad-url}[CoCoVaD Chair]
...
:irit: https://www.irit.fr/en/home/[IRIT](((IRIT)))
...
:ut2j: {univ-tlse2}
:airbus: https://www.airbus.com/[Airbus]
:crt: https://www.airbus.com/en/innovation[Central Research and Technology]
// data divers
...
:lemonTree: https://help.lieberlieber.com/display/LT/LemonTree+and+GitFlow