...
The proposed solution will have to consider the key objectives and considerations expressed in Section <<context>>, and will have to interoperate with the targeted rule-based Continuous Integration platform as explored by WP2.
...
committee helps him in this charge, under the supervision of the Strategic Orientation Committee (Section <<soc>>).
