...
You will be member of the {irit} laboratory and join the {Airbus} IDMR department, in charge of the Modeling & Simulation research program of the _Digital Design Manufacturing & Services_ (DDMS) transformation of the company.

You will be responsible of the main following activities:

- Writing the requirements for the projects
...
- Helping refine upcoming Ph.Ds perimeters and missions
...
- A Ph.D. in eithe Model-Based or Systems Engineering (ideally both);
...
- Excellent English skills (both spoken and written) for scientific communication (although French may certainly be used for everyday life);
