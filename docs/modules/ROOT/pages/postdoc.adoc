...
Hold at {ut2j}, in collaboration with {irit} Laboratory, 
the project takes place in an industrial Chair with {Airbus}, the worldwide aeronautic leader. 
...
Outstanding candidates will have the opportunity to work in advanced topics.
{Airbus} intends to hire in permanent contract (_CDI_ in French) the selected engineer at the end of the postdoc.
...
- Notions of Systems Engineering;
...
communication (although French may certainly be used for every-day life);
- Aiming at joining Airbus at the end of the post-doc to integrate the MBSE team and continue working on the Chaire activities.
...
Toulouse is the capital of Occitanie and Aeronotics.  It is a well connected city,
with lots of students and IT companies.

The funding is a available for a duration of one year, with a possible extension of 6 months (for a total of 1.5 years), and amounts up to 4.000 €/month according to the candidate experience.
...
The selection will include an interview (most likely operated online) consisting in presenting the candidate's views on his own experience and the relevance for the project, as well as early takeouts on the project's topic.

The University of Toulouse promotes diversity in employment and welcomes applications from all sections of the community.
